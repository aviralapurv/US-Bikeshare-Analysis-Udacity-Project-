...
\textbf{Answer}: Data is really powerful ! Many questions can be
answered from data, some of them are: 1.) What are the
sales/subscriptions of each city for bikeshare. 2.) If there occurs any
behavioural anomaly with the bikes. 3.) Predictions can be made too with
the data based on historical data of the bikeshare in respective city.
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} import all necessary packages and functions.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{print\PYZus{}first\PYZus{}point}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}   \PY{c+c1}{\PYZsh{}Cityname for ref....}
        ...
        \PY{c+c1}{\PYZsh{}Datafiles at location ./DAta}
...
below to address each of the cleaning tasks described above.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}} \PY{o+ow}{or} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{k}{return} \PY{n+nb}{float}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tripduration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{60} \PY{c+c1}{\PYZsh{}minutes}
            \PY{k}{else}\PY{p}{:}
                \PY{k}{return} \PY{n+nb}{float}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (ms)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{60000} \PY{c+c1}{\PYZsh{}milisecs}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                ...
                \PY{n}{tim} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{starttime}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} 
                \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{tim}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{month} \PY{o}{=}\PY{n+nb}{int}\PY{p}{(}\PY{n}{tim}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
                \PY{n}{hour}\PY{o}{=}\PY{n+nb}{int}\PY{p}{(}\PY{n}{tim}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
                
            \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                
                \PY{n}{starttime} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                \PY{n}{d} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{starttime}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} 
                \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{d}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{month} \PY{o}{=}\PY{n+nb}{int}\PY{p}{(}\PY{n}{d}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
                \PY{n}{hour}\PY{o}{=}\PY{n+nb}{int}\PY{p}{(}\PY{n}{d}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
be consistent with the example file.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{condense\PYZus{}data}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{n}{out\PYZus{}file}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
            ...
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{out\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{w}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}out}\PY{p}{,} \PY{n+nb}{open}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                ...
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{trip\PYZus{}reader}\PY{p}{:}      \PY{c+c1}{\PYZsh{}Setting up a dictionary to hold datums. !!!}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} Run this cell to check your work}
         ...
         \PY{k}{for} \PY{n}{city}\PY{p}{,} \PY{n}{filenames} \PY{o+ow}{in} \PY{n}{city\PYZus{}info}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n+nb}{print}\PY{p}{(}\PY{n+nb}{type}\PY{p}{(}\PY{n}{city\PYZus{}info}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: 1. NYC is the city with the highest number of trips. 2.
NYC is the city with the highest proportion of trips made by subscribers
3. Chicago is the city with the highest proportion of trips made by
short-term customers

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{n}{reader}\PY{o}{=}\PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)} \PY{c+c1}{\PYZsh{}initialise variables}
                 \PY{n}{n\PYZus{}subscribers}\PY{o}{=}\PY{l+m+mi}{0}
                 \PY{n}{n\PYZus{}customers}\PY{o}{=}\PY{l+m+mi}{0}   \PY{c+c1}{\PYZsh{}Tally rides}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     ...
                     \PY{k}{else}\PY{p}{:}
                         \PY{n}{n\PYZus{}customers} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}    \PY{c+c1}{\PYZsh{}now computing total no of rides !}
                 \PY{n}{n\PYZus{}total}\PY{o}{=}\PY{n}{n\PYZus{}subscribers}\PY{o}{+}\PY{n}{n\PYZus{}customers}
                 \PY{n}{sub\PYZus{}proportion}\PY{o}{=}\PY{p}{(}\PY{n}{n\PYZus{}subscribers}\PY{o}{/}\PY{n}{n\PYZus{}total}\PY{p}{)}\PY{o}{*}\PY{l+m+mi}{100}
                 \PY{n}{cus\PYZus{}proportion}\PY{o}{=}\PY{p}{(}\PY{n}{n\PYZus{}customers}\PY{o}{/}\PY{n}{n\PYZus{}total}\PY{p}{)}\PY{o}{*}\PY{l+m+mi}{100}
                 \PY{k}{return}\PY{p}{(}\PY{n}{n\PYZus{}subscribers}\PY{p}{,} \PY{n}{n\PYZus{}customers}\PY{p}{,} \PY{n}{n\PYZus{}total}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{k}{for} \PY{n}{datafile} \PY{o+ow}{in} \PY{n}{data\PYZus{}file}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{datafile}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: For Chicago: 1. Average length of trip duration is :
16.563629368787335 mins 2. Proportion of trips over 30 mins :
8.332062497400562\%

For NYC: 1. Average length of trip duration is : 15.81259299802294 mins
2. Proportion of trips over 30 mins : 7.3024371563378345\%

For DC: 1. Average length of trip duration is : 18.93287355913721 mins
2. Proportion of trips over 30 mins : 10.83888671109369\%

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{k}{def} \PY{n+nf}{duration\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function reads in a file with trip data and calculates average trip length for the city}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{c+c1}{\PYZsh{} set up csv reader object}
                 ...
                 \PY{n}{n\PYZus{}long\PYZus{}trips}\PY{o}{=}\PY{l+m+mi}{0}
                 \PY{n}{n\PYZus{}time}\PY{o}{=}\PY{l+m+mi}{0}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{n}{n\PYZus{}trips}\PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                     \PY{n}{n\PYZus{}time}\PY{o}{+}\PY{o}{=}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                     \PY{k}{if} \PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{\PYZgt{}}\PY{l+m+mi}{30}\PY{p}{)}\PY{p}{:}
                         \PY{n}{n\PYZus{}long\PYZus{}trips}\PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1} 
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Average length of trip duration is:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{mins}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{n\PYZus{}time}\PY{o}{/}\PY{n}{n\PYZus{}trips}\PY{p}{)}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Proportion of trips longer than 30 mins:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{n\PYZus{}long\PYZus{}trips}\PY{o}{*}\PY{l+m+mi}{100}\PY{o}{/}\PY{n}{n\PYZus{}trips}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For DC:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{dc\PYZus{}trips}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{duration\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{dc\PYZus{}trips}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For Chicago:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{chi\PYZus{}trips}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}} 
         \PY{n}{duration\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{chi\PYZus{}trips}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For NYC:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{nyc\PYZus{}trips} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{duration\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{nyc\PYZus{}trips}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: I choose the NYC city as (`Customer average is:',
0.11164098006488486, `Subscriber average is:', 0.8883590199351151)

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{k}{def} \PY{n+nf}{Average\PYZus{}user\PYZus{}type}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{:}
             \PY{n}{users\PYZus{}per\PYZus{}city}\PY{o}{=}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
             \PY{n}{average\PYZus{}subscriber}\PY{o}{=}\PY{n}{users\PYZus{}per\PYZus{}city}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{n}{users\PYZus{}per\PYZus{}city}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
             \PY{n}{average\PYZus{}customer}\PY{o}{=}\PY{n}{users\PYZus{}per\PYZus{}city}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{n}{users\PYZus{}per\PYZus{}city}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
             \PY{k}{if} \PY{n}{average\PYZus{}subscriber}\PY{o}{\PYZgt{}}\PY{n}{average\PYZus{}customer}\PY{p}{:}
                 \PY{n}{user\PYZus{}type}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{subscriber}\PY{l+s+s2}{\PYZdq{}}
                 \PY{n}{average}\PY{o}{=}\PY{n}{average\PYZus{}subscriber}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{user\PYZus{}type}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{customer}\PY{l+s+s2}{\PYZdq{}}
                 \PY{n}{average}\PY{o}{=}\PY{n}{average\PYZus{}customer}
             \PY{k}{return}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Customer average is: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{average\PYZus{}customer}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Subscriber average is: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{average\PYZus{}subscriber}\PY{p}{)}
         \PY{n}{data\PYZus{}file}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{Average\PYZus{}user\PYZus{}type}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
library and to generate an example plot.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} we will import matplotlib for visualisations, ggplot could have also been used.}
         \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt} \PY{c+c1}{\PYZsh{} Matplotlib is a Python 2D plotting library which produces publication quality figures in a variety of hardcopy formats and interactive environments}
         \PY{c+c1}{\PYZsh{} http://ipython.readthedocs.io/en/stable/interactive/magics.html}
         \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline  
          \PY{c+c1}{\PYZsh{}example from bayarea dataset}
         \PY{n}{data} \PY{o}{=} \PY{p}{[} \PY{l+m+mf}{7.65}\PY{p}{,}\PY{l+m+mf}{8.92}\PY{p}{,}\PY{l+m+mf}{7.42}\PY{p}{,}\PY{l+m+mf}{5.50}\PY{p}{,}\PY{l+m+mf}{16.17}\PY{p}{,}\PY{l+m+mf}{4.20}\PY{p}{,}\PY{l+m+mf}{8.98}\PY{p}{,}\PY{l+m+mf}{9.62}\PY{p}{,}\PY{l+m+mf}{11.48}\PY{p}{,}\PY{l+m+mf}{14.33}\PY{p}{,}\PY{l+m+mf}{19.02}\PY{p}{,}\PY{l+m+mf}{21.53}\PY{p}{,}\PY{l+m+mf}{3.90}\PY{p}{,}\PY{l+m+mf}{7.97}\PY{p}{,}\PY{l+m+mf}{2.62}\PY{p}{,}\PY{l+m+mf}{2.67}\PY{p}{,}\PY{l+m+mf}{3.08}\PY{p}{,}\PY{l+m+mf}{14.40}\PY{p}{,}\PY{l+m+mf}{12.90}\PY{p}{,}\PY{l+m+mf}{7.83}\PY{p}{,}
                 \PY{l+m+mf}{25.12}\PY{p}{,}\PY{l+m+mf}{8.30}\PY{p}{,}\PY{l+m+mf}{4.93}\PY{p}{,}\PY{l+m+mf}{12.43}\PY{p}{,}\PY{l+m+mf}{10.60}\PY{p}{,}\PY{l+m+mf}{6.17}\PY{p}{,}\PY{l+m+mf}{10.88}\PY{p}{,}\PY{l+m+mf}{4.78}\PY{p}{,}\PY{l+m+mf}{15.15}\PY{p}{,}\PY{l+m+mf}{3.53}\PY{p}{,}\PY{l+m+mf}{9.43}\PY{p}{,}\PY{l+m+mf}{13.32}\PY{p}{,}\PY{l+m+mf}{11.72}\PY{p}{,}\PY{l+m+mf}{9.85}\PY{p}{,}\PY{l+m+mf}{5.22}\PY{p}{,}\PY{l+m+mf}{15.10}\PY{p}{,}\PY{l+m+mf}{3.95}\PY{p}{,}\PY{l+m+mf}{3.17}\PY{p}{,}\PY{l+m+mf}{8.78}\PY{p}{,}\PY{l+m+mf}{1.88}\PY{p}{,}
         ...
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Trip Durations}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}19}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
         \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline 
         \PY{k}{def} \PY{n+nf}{city\PYZus{}trip\PYZus{}duration}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
           
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{reader}\PY{o}{=}\PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 \PY{n}{n\PYZus{}trips\PYZus{}all}\PY{o}{=}\PY{p}{[}\PY{p}{]}        
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{n}{n\PYZus{}trips\PYZus{}all}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                 \PY{k}{return} \PY{n}{n\PYZus{}trips\PYZus{}all}
         \PY{c+c1}{\PYZsh{}plotting the graphs (Detaisl)}
         \PY{n}{data}\PY{o}{=}\PY{n}{city\PYZus{}trip\PYZus{}duration}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{c+c1}{\PYZsh{}as we have used NYC in 4c so data of NYC summary is taken from ./data          }
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Trip Durations}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
...
\textbf{Answer}: City selected = NYC

For subscribers = Peak : Between 5 - 10 mins , For customer = Peak :
between 20 - 305 mins

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{k+kn}{import} \PY{n+nn}{pandas} \PY{k}{as} \PY{n+nn}{pd}
         \PY{n}{df} \PY{o}{=}\PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{city\PYZus{}file} \PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{k}{def} \PY{n+nf}{duration\PYZus{}ridership}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{fetch}\PY{p}{)}\PY{p}{:}
             \PY{n}{duration}\PY{o}{=}\PY{p}{[}\PY{p}{]}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}  
                 \PY{n}{reader}\PY{o}{=}\PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:} 
                     \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{n}{fetch}\PY{p}{:}
                         \PY{n}{durations}\PY{o}{=}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                         \PY{n}{duration}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{durations}\PY{p}{)}\PY{p}{;}
             \PY{k}{return} \PY{n}{duration}
         \PY{n}{bins}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{15}\PY{p}{,}\PY{l+m+mi}{20}\PY{p}{,}\PY{l+m+mi}{25}\PY{p}{,}\PY{l+m+mi}{30}\PY{p}{,}\PY{l+m+mi}{35}\PY{p}{,}\PY{l+m+mi}{40}\PY{p}{,}\PY{l+m+mi}{45}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{55}\PY{p}{,}\PY{l+m+mi}{60}\PY{p}{,}\PY{l+m+mi}{65}\PY{p}{,}\PY{l+m+mi}{70}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{]}
         \PY{n}{duration} \PY{o}{=} \PY{n}{duration\PYZus{}ridership}\PY{p}{(}\PY{n}{city\PYZus{}file}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{duration}\PY{p}{,}\PY{n}{bins}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}locations = bins + 5}
         \PY{c+c1}{\PYZsh{}plt.xticks(locations, labels)}
         \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Graphs for question 5}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration(m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Trip Durations for subscribers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Graphs for subs}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{duration} \PY{o}{=} \PY{n}{duration\PYZus{}ridership}\PY{p}{(}\PY{n}{city\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{duration}\PY{p}{,} \PY{n}{bins}\PY{p}{)} \PY{c+c1}{\PYZsh{}locations=bin+5}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration(m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Trip Durations for subscribers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: Most Busiest time for Customers as well as subscribers
for the city NYC Answer :\\
1. For customers the busiest time is around 3:00 p.m 2. For subscribers
the busiest time is around 3:00 p.m to 6:00 p.m

This data will be useful to gain insight of the busiest time so that
proper measures are taken beforehand to ensure proper and full supply
for cutomer satifaction, also can be used to provide dicount or offers
at the time to boost sales.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
         \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline 
         \PY{k}{def} \PY{n+nf}{user\PYZus{}month\PYZus{}plotting}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{reader}\PY{o}{=}\PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 \PY{n}{n\PYZus{}trips\PYZus{}s}\PY{o}{=}\PY{p}{[}\PY{p}{]} \PY{c+c1}{\PYZsh{}Subscribers Actual}
                 \PY{n}{n\PYZus{}trips\PYZus{}c}\PY{o}{=}\PY{p}{[}\PY{p}{]} \PY{c+c1}{\PYZsh{}Customers (nyc)}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{k}{if} \PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
                         \PY{n}{n\PYZus{}trips\PYZus{}c}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hour}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                     \PY{k}{else}\PY{p}{:}
                         \PY{n}{n\PYZus{}trips\PYZus{}s}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hour}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                 \PY{k}{return} \PY{p}{(}\PY{n}{n\PYZus{}trips\PYZus{}s}\PY{p}{,}\PY{n}{n\PYZus{}trips\PYZus{}c}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}taking input of data}
         \PY{n}{data} \PY{o}{=} \PY{n}{user\PYZus{}month\PYZus{}plotting}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{val\PYZus{}s} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
         \PY{n}{val\PYZus{}c} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
         \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{customers plotting for the most busiest time}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{val\PYZus{}c}\PY{p}{,} \PY{n}{normed}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{l+m+mi}{50}\PY{p}{,}\PY{n}{stacked}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{stacked}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Hours}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Trip Hour for NYC Customers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscribers plotting for the most busiest time}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{val\PYZus{}s}\PY{p}{,} \PY{n}{normed}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{l+m+mi}{50}\PY{p}{,}\PY{n}{stacked}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{stacked}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Hours}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Trip Hour for NYC Suscribers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
